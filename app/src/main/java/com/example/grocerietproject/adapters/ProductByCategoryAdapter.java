...
public class ProductByCategoryAdapter extends RecyclerView.Adapter<ProductViewHolder> {
    AppDatabase db;
    ...
    public ProductByCategoryAdapter(List<ProductRecycle> mProducts, Context context, NavController navController){
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, int position) {
        ...
        holder.layoutProductRecyclerView.setOnClickListener(v -> {
            Bundle bundle = new Bundle();
            bundle.putInt("productId", product.getProductId());
            navController.navigate(R.id.action_productByCategoryFragment_to_productDetailFragment,bundle);
        });
